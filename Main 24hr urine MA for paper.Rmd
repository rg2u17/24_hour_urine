...
## Import data
```{r}
urine_ma <- fread("Data/24_hr_urine_ma_12082025.csv", header = TRUE) %>% janitor::clean_names()

hpfs_nhs_I_II_summary <- fread("Data/24_hr_urine_ma_nhs_hpfs_data.csv", header = TRUE) %>% 
  janitor::clean_names()

phosphate_phosphorous <- fread("Data/phosphate_phosphorous.csv", header = TRUE) %>% janitor::clean_names()
```
\newpage
